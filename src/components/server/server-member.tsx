...
import UserAvator from "../user-avatar";
    ...
    >
      ...
      <p
        className={cn(
          ...
          "dark:text-indigo-400 dark:group-hover:text-zinc-300 transition",
          params?.memberId === member.id &&
          "text-primary dark:to-zinc-200 dark:group-hover:text-white"
        )}
      >
        {member.profile.name}
      </p>
